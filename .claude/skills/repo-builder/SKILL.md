...
Invoke `/setup-matt-pocock-skills` with the Skill tool at the step `references/generate.md` gives it, before wayfinding. Invoke it rather than answering its questions yourself or reproducing what it writes.
