...
echo "Follow the DocSync contract in CLAUDE.md: read the CLAUDE.md chain for every path you touch before editing, and update the owning docs after meaningful changes."
