...
- `src/base-repo/apps/app-name/` is renamed during generation. The root `CLAUDE.md` of the payload carries the Apps section instructing that rename; a placeholder that only looks like a convention gets kept rather than replaced.
