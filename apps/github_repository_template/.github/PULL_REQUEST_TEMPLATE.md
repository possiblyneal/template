...
<!-- What changed? Keep this brief and concrete. -->

## Linked issue or goal

<!-- URL or exact ticket ID so the agent can fetch the original requirements -->

## Changes made

<!-- List the important changes. Focus on reviewer-relevant behavior, not every file touched. -->
...
<!-- Paste raw CLI output or test logs here. Agents prefer raw logs over summaries. -->
