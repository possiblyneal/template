...
- `research/` — findings gathered by the `research` skill, one Markdown file per question, each citing the source it read. A record of what was found, not a decision: a decision it supports belongs in an ADR or a ticket answer
